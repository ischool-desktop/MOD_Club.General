...
namespace K12.Club.General
{
    public class Program
    {
        ...
        static public void Main()
        {
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new K12.Club.General.CLUB.ExportCLUBData();
                K12.Club.General.CLUB.ExportStudentV2 wizard = new K12.Club.General.CLUB.ExportStudentV2(exporter.Text, exporter.Image);
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new K12.Club.General.CLUB.SpecialResult();
                K12.Club.General.CLUB.ExportStudentV2 wizard = new K12.Club.General.CLUB.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
            ...
            {
                SmartSchool.API.PlugIn.Export.Exporter exporter = new K12.Club.General.CLUB.ClubCadResult();
                K12.Club.General.CLUB.ExportStudentV2 wizard = new K12.Club.General.CLUB.ExportStudentV2(exporter.Text, exporter.Image);
                exporter.InitializeExport(wizard);
                wizard.ShowDialog();
            };
